...
Если есть возможность, очень прошу проверить задание в среду или четверг, так как поехала верстка, не успел поправить=(
Заранее спасибо!
Моя оценка - 195 баллов 
Отзыв по пунктам ТЗ:
...
feedback: Изображения не везде загружаются плавно, но и не прогружаются по частям
Выполненные пункты:
